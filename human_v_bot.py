                ...
                if game.next_player == gotypes.Player.black:
                    ...
                    if event.button == 1 and board.outline.collidepoint(event.pos):
                        ...
                        if stone:
                            ...
                            print("liberties updated")
                            human_move = goboard.Move.play(gotypes.Point(row=x, col=y))
                            game.apply_move(human_move)
                            game.next_player = gotypes.Player.white
                    ...
                    bot_move = agent.select_move(game)
                    ...
                    board.update_liberties(added_stone)
                    game.next_player = gotypes.Player.black
